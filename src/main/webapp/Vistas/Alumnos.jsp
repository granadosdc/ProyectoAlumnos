<%-- 
    ...
    Created on : 15 jul. 2021, 17:23:18
    Author     : cielo
--%>
                        ...
                        <%
                         ...
                         String rutaE ="Alumnoscontroller?accion=eliminar&id="+resultado.get(i).getId();
                          ...
                          <tr>
                              ...
                              <td> <%= resultado.get(i).getApellido()%></td><!-- Estos metodos se estan trayendo de la clase alumnoscomment -->
...
</html><!-- Creando la conexión de mi WebApp con java Controlador 
